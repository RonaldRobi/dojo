...
<head>
    ...
    <title>Parent Registration - Droplets Dojo</title>
    ...
    <div class="min-h-screen flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full mx-auto">
            ...
            <div class="text-center mb-8">
                ...
                <h2 class="text-3xl font-bold text-gray-900 mb-2">Parent Registration</h2>
                <p class="text-gray-600">Enter your email to receive a registration link</p>
            </div>

            <!-- Success Message -->
            @if(session('success'))
                <div class="mb-6 rounded-lg bg-green-50 border border-green-200 p-5">
                    <div class="flex">
                        ...
                        <div class="ml-3 flex-1">
                            ...
                            <div class="mt-3 p-3 bg-green-100 rounded-lg">
                                <p class="text-xs text-green-700 mb-2 flex items-start">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
                <form method="POST" action="{{ route('parent.register.send') }}">
                    @csrf
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative">
                            ...
                            <input 
                                ...
                                required 
                                value="{{ old('email') }}"
                                class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition duration-200 @error('email') border-red-500 @enderror" 
            ...
            <div class="mt-6 text-center">
                <a href="{{ route('login') }}" class="text-sm font-medium text-purple-600 hover:text-purple-500 transition-colors">
                    ← Back to Login
                </a>
            </div>
        </div>
