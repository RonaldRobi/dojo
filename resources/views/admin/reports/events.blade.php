<x-app-layout>
    <x-slot name="header">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">View event statistics</p>
        </div>
    </x-slot>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-semibold text-gray-700 uppercase">Registrations</th>
                    </tr>
                </thead>
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($events as $event)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-blue-600">{{ $event->registrations_count ?? 0 }}</td>
                        </tr>
                    @empty
