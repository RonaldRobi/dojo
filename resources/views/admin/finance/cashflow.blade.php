<x-app-layout>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 bg-white flex items-center justify-between">
            ...
            <div class="text-2xl font-bold text-green-600">RM {{ number_format($totalCashflow, 2) }}</div>
        </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse($byMethod as $method)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-green-600">RM {{ number_format($method->total, 2) }}</td>
