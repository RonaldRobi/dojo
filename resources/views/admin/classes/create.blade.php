    ...
    <x-slot name="header">
        <div class="flex items-center">
            ...
            <div>
                ...
                <p class="text-xs sm:text-sm text-gray-600 mt-1">Add a new class to a branch</p>
            </div>
        </div>
    </x-slot>

    <div class="max-w-4xl mx-auto">
        <form action="{{ route('admin.classes.store') }}" method="POST" class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="number" name="max_capacity" id="max_capacity" value="{{ old('max_capacity', 30) }}" min="1"
                        placeholder="e.g., 30"
