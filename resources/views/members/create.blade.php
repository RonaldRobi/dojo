    ...
    <div class="py-6">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="member-form" action="{{ route('owner.members.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="date" name="join_date" id="join_date" value="{{ old('join_date', date('Y-m-d')) }}"
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="medical_notes" id="medical_notes" rows="3"
                                          ...
                                          placeholder="Any medical conditions or allergies...">{{ old('medical_notes') }}</textarea>
                                @error('medical_notes')
                                    <p class="form-error">{{ $message }}</p>
                                @enderror
                            </div>
