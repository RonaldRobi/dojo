<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">Create a new attendance record</p>
            </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <form method="POST" action="{{ route('owner.attendances.store') }}">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="date" name="attendance_date" value="{{ old('attendance_date', now()->format('Y-m-d')) }}" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500">
                ...
                <div>
                    ...
                    <select name="checked_in_method" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500">
                        ...
                        <option value="qr" {{ old('checked_in_method') == 'qr' ? 'selected' : '' }}>QR Code</option>
                        <option value="manual" {{ old('checked_in_method') == 'manual' ? 'selected' : '' }}>Manual</option>
                    </select>
                </div>
